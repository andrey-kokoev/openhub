...
export function openhubPlugin(options: PluginOptions = {}) {
  return {
    ...
    async config(vinxiConfig: VinxiConfig) {
      ...
      vinxiConfig.server.nitro.runtimeConfig =
        vinxiConfig.server.nitro.runtimeConfig || {};
      vinxiConfig.server.nitro.runtimeConfig.openhub =
        vinxiConfig.server.nitro.runtimeConfig.openhub || {};
      vinxiConfig.server.nitro.runtimeConfig.openhub.remote =
        options.remote || false;
      vinxiConfig.server.nitro.runtimeConfig.openhub.provider =
        options.provider;
